...
SecureChat is a 4th-year Cryptography and Network Security course project demonstrating hybrid cryptography for real-time messaging, with a focus on End-to-End Encryption (E2EE), integrity checking, and forward secrecy through session key rotation.
